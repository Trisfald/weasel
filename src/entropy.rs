...
impl<R: BattleRules> Entropy<R> {
    ...
    pub fn generate<T: EntropyNum>(&mut self, low: T, high: T) -> T 
     {
...
/// Trait bounds for the numbers generated by all entropy rules.
pub trait EntropyNum: PartialOrd + Copy + Num + Debug {}

impl<T> EntropyNum for T where T: PartialOrd + Copy + Num + Debug {}
